/**
 * Admin Profile Page - Premium Dark Glass Design
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div>
                ...
                <p className="text-gray-400 text-sm mt-1">Manage your account settings and password</p>
            </div>

            {/* Profile Card */}
            <div className="bg-[#0f1218] rounded-2xl border border-white/5 overflow-hidden">
                {/* Profile Header */}
                <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 p-6 border-b border-white/5">
                ...
                {/* Account Info */}
                <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 border-b border-white/5">
                ...
                <form onSubmit={handleProfileSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                        ...
                        <button
                            ...
                            className="ml-auto flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-medium rounded-xl hover:shadow-lg hover:shadow-emerald-500/25 transition-all disabled:opacity-50"
                        >
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all text-sm"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all text-sm"
                                placeholder="••••••••"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                        ...
                        <button
                            ...
                            className="ml-auto flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-medium rounded-xl hover:shadow-lg hover:shadow-amber-500/25 transition-all disabled:opacity-50"
                        >
