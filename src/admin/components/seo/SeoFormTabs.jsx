...
export default function SeoFormTabs({ seo = {}, onChange, onSuggest, entityName = '' }) {
    ...
    return (
        <div className="bg-[#0f1218] rounded-2xl border border-white/5 shadow-xl shadow-black/20 overflow-hidden">
            {/* Tabs */}
            <div className="flex border-b border-white/5 overflow-x-auto bg-white/[0.02]">
                {tabs.map((tab) => (
                    <button
                        key={tab.id}
            ...
            <div className="p-6">
                ...
                {activeTab === 'general' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5">
                            <h3 className="text-sm font-medium text-gray-400 mb-4">Search Engine Preview</h3>
                    ...
                    <div className="space-y-8 animate-fade-in">
                        ...
                        <div>
                            <h3 className="font-semibold text-white mb-4 flex items-center gap-2">
                                <Share2 size={18} className="text-blue-400" /> Open Graph (Facebook, LinkedIn)
                            </h3>
                            <div className="space-y-4 p-4 bg-white/5 rounded-xl border border-white/5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                        ...
                        <div>
                            <h3 className="font-semibold text-white mb-4 flex items-center gap-2">
                                <Share2 size={18} className="text-sky-400" /> Twitter Card
                            </h3>
                            <div className="space-y-4 p-4 bg-white/5 rounded-xl border border-white/5">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-sky-500/50 transition-colors"
                                    >
                                ...
                                <div>
                                    <label className="block text-sm text-gray-400 mb-1">Twitter Title</label>
                                    <input
                                        type="text"
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <label key={opt.key} className="flex items-center gap-3 cursor-pointer p-3 bg-white/5 rounded-lg border border-white/5 hover:bg-white/10 transition-colors">
                                        <input
                                            type="checkbox"
                                            ...
                                            className="w-4 h-4 text-emerald-500 rounded border-gray-600 bg-gray-700 focus:ring-emerald-500 focus:ring-offset-gray-900"
                                        />
                ...
                {activeTab === 'schema' && (
                    <div className="space-y-6 animate-fade-in">
                        <div className="flex items-start gap-3 p-4 bg-blue-500/10 text-blue-400 rounded-xl border border-blue-500/20">
                        ...
                        <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                />
                                <span className="text-base font-medium text-white">Auto-generate schema from product data</span>
                            </label>
                        </div>
                        ...
                        {seo.jsonLd?.autoGenerate === false && (
                            <div className="animate-fade-in">
                                ...
                                <textarea
                                    ...
                                    rows={12}
                                    className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 font-mono text-sm text-emerald-400 focus:outline-none focus:border-emerald-500/50 transition-colors"
                ...
                <div className="px-6 py-4 border-t border-white/5 bg-white/[0.02]">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <span className="font-bold text-white text-lg">{seo.seoScore}%</span>
                                <span className="text-gray-500 text-sm ml-2">SEO Optimization Score</span>
                            </div>
                        </div>
